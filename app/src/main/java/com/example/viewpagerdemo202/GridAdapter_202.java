...
public class GridAdapter_202 extends RecyclerView.Adapter<GridAdapter_202.ViewHolder_202> {

    private List<TipModel_202> tipList_202;

    public GridAdapter_202(List<TipModel_202> tipList_202) {
    ...
    public ViewHolder_202 onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view_202 = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_tip_grid_202, parent, false);
